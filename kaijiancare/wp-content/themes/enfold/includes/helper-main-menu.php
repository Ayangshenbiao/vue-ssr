...
//						    }
        ...
        $output .= "<div id='header-search-form'><form role='search' method='get' id='searchform' action='".home_url( '/' )."'><input type='text' placeholder='search' name='s'><button type='submit'>搜索</button></form></div>";

        $output .= "<div class='phone-info web-phone'><span>".do_shortcode($phone)."</span></div>";
